...
//working good
const sumFunc3 = (a:number, b:number, c:number = 0) => {
...
//not working
const sumFunc4 = (a:number, b:number, c:number = 0) => {
    console.log(a + b + c);
...
/*Return Type*/
//working good
const sumFunc5 = (a:number, b:number, c:number = 0) : number => {
    return a + b + c;
};
